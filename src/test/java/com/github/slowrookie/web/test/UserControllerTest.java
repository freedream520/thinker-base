...
public class UserControllerTest extends AbstractTest{
	...
	public void saveUser(){
		...
		User user = new User(1L, "liujx", "刘","佳兴", "3", 1, "liujiaxingemail@gmail.com", "17092080066", "00000000");
	...
	public void saveUsers(){
		...
		User user = new User(1L, "liujx1", "刘","佳兴", "3", 1, "liujiaxingemail@gmail.com", "17092080066", "00000000");
		User user1 = new User(1L, "liujx2", "刘","佳兴", "3", 1, "liujiaxingemail@gmail.com", "17092080066", "00000000");
		users.add(user);
		users.add(user1);
